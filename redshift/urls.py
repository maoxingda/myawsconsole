...
urlpatterns = [
    ...
    path(
        "queryhistory/refresh_query_history/",
        views.refresh_query_history,
        name="refresh_query_history",
    ),
    path("queryhistory/vacuum/", views.vacuum, name="vacuum"),
    path(
        "launch_restore_table_task/<int:task_id>/",
        views.launch_restore_table_task,
        name="launch_restore_table_task",
    ),
    path(
        "launch_restore_cluster_task/<int:task_id>/",
        views.launch_restore_cluster_task,
        name="launch_restore_cluster_task",
    ),
