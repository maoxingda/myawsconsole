...
AWS_DMS_URL = (
    "https://cn-northwest-1.console.amazonaws.cn/dms/v2/home?region=cn-northwest-1"
)
AWS_REDSHIFT_URL = (
    "https://cn-northwest-1.console.amazonaws.cn/redshiftv2/home?region=cn-northwest-1"
)
# MY_AWS_URL              = 'http://127.0.0.1:8000' if os.getlogin() == 'root' else 'http://127.0.0.1:8089'
MY_AWS_URL = "http://127.0.0.1:8000"
