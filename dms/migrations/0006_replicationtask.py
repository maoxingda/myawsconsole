    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replication_task_creation_date', models.DateTimeField(default=django.utils.timezone.now)),
                ('replication_task_identifier', models.CharField(max_length=255, unique=True)),
                ('replication_task_settings', models.JSONField()),
                ('replication_task_start_date', models.DateTimeField(default=django.utils.timezone.now)),
